<div class="row">
    <div class="col-xs-12">
	    ...
	    <div class="form-group <?php if(form_error('anak_ke')) echo 'has-error'?> ">
	    ...
	    <div class="form-group <?php if(form_error('jumlah_saudara')) echo 'has-error'?> ">
	    ...
	    <div class="form-group <?php if(form_error('no_hp_siswa')) echo 'has-error'?> ">
                            <label for="varchar">No Hp Siswa</label>
                            <input type="text" class="form-control" name="no_hp_siswa" id="no_hp_siswa" placeholder="No Hp Siswa" value="<?php echo $no_hp_siswa; ?>" />
                            <?php echo form_error('no_hp_siswa', '<small style="color:red">','</small>') ?>
                        </div>
	    <div class="form-group <?php if(form_error('alamat_siswa')) echo 'has-error'?> ">
	    ...
	    <div class="form-group <?php if(form_error('berat_badan')) echo 'has-error'?> ">
	    ...
	    <div class="form-group <?php if(form_error('tinggi_badan')) echo 'has-error'?> ">
	    ...
	    <div class="form-group <?php if(form_error('gol_darah')) echo 'has-error'?> ">
	    ...
	    <div class="form-group <?php if(form_error('asal_sekolah')) echo 'has-error'?> ">
	    ...
	    <div class="form-group <?php if(form_error('alamat_sekolah')) echo 'has-error'?> ">
	    ...
	    <div class="form-group <?php if(form_error('nama_ayah')) echo 'has-error'?> ">
	    ...
	    <div class="form-group <?php if(form_error('nama_ibu')) echo 'has-error'?> ">
	    ...
	    <div class="form-group <?php if(form_error('alamat_orang_tua')) echo 'has-error'?> ">
                            <label for="alamat_orang_tua">Alamat Orang Tua</label>
                            <textarea class="form-control" rows="3" name="alamat_orang_tua" id="alamat_orang_tua" placeholder="Alamat Orang Tua"><?php echo $alamat_orang_tua; ?></textarea>
                            <?php echo form_error('alamat_orang_tua', '<small style="color:red">','</small>') ?>
                        </div>
	    <div class="form-group <?php if(form_error('no_hp_orang_tua')) echo 'has-error'?> ">
                            <label for="varchar">No Hp Orang Tua</label>
                            <input type="text" class="form-control" name="no_hp_orang_tua" id="no_hp_orang_tua" placeholder="No Hp Orang Tua" value="<?php echo $no_hp_orang_tua; ?>" />
                            <?php echo form_error('no_hp_orang_tua', '<small style="color:red">','</small>') ?>
                        </div>
	    <div class="form-group <?php if(form_error('penghasilan_orang_tua')) echo 'has-error'?> ">
	    ...
	    <div class="form-group <?php if(form_error('tanggungan_anak')) echo 'has-error'?> ">
	    ...
	    <div class="form-group <?php if(form_error('status_lolos')) echo 'has-error'?> ">
