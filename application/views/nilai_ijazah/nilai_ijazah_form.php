        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="pull-right">
                    <div class="box-title">
                        <a href="<?php echo base_url('nilai_ijazah') ?>" class="btn btn-primary"><i
                        ...
                        <form action="<?php echo $action; ?>" method="post">
                            ...
                            <div class="form-group <?php if (form_error('nilai_bhs_indo'))
                                echo 'has-error' ?> ">
                                    ...
                                    <input type="text" class="form-control" name="nilai_bhs_indo" id="nilai_bhs_indo"
                                        placeholder="Nilai Bhs Indo" value="<?php echo $nilai_bhs_indo; ?>" />
                            ...
                            <div class="form-group <?php if (form_error('nilai_bhs_inggris'))
                                echo 'has-error' ?> ">
                                    ...
                                    <input type="text" class="form-control" name="nilai_bhs_inggris" id="nilai_bhs_inggris"
                                        placeholder="Nilai Bhs Inggris" value="<?php echo $nilai_bhs_inggris; ?>" />
