        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="pull-right">
                    <div class="box-title">
                        <a href="<?php echo base_url('users') ?>" class="btn btn-primary"><i
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <form action="<?php echo $action; ?>" method="post">
                            ...
                            <div class="form-group <?php if (form_error('level'))
                                echo 'has-error' ?> ">
                                    ...
                                    <select class="form-control" name="level" id="level" required>
                                        <option <?=$level == 0 ? "selected" : ""; ?> value="0">Administrator</option>
                                        <option <?=$level == 1 ? "selected" : ""; ?> value="1">Calon Siswa</option>
                                    </select>
